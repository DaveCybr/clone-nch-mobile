...
class PresensiService {
  ...
  PresensiService() {
    ...
    // Add interceptor for automatic token authentication
      ...
      InterceptorsWrapper(
        onRequest: (options, handler) async {
          try {
            ...
            developer.log(
              'Error adding token to request: $e',
  ...
  Future<List<MataPelajaranModel>> fetchMataPelajaranByKelas(
    ...
    try {
      ...
      developer.log('Base URL: $_baseUrl', name: 'PresensiService', level: 900);
      developer.log('Token: ${token}', name: 'PresensiService', level: 900);
  ...
  Future<List<JadwalModel>> fetchJadwalBySubject(dynamic subjectId) async {
    // Changed from int to dynamic to support UUID
    try {
