class ScheduleModel {
  ...
  final dynamic timeSlotId; // Added to support time slot ID (can be UUID or int)
  ...
  factory ScheduleModel.fromJson(Map<String, dynamic> json) {
    return ScheduleModel(
      ...
      subjectTeacherId: json['subject_teacher_id']?.toString() ?? '0', // Convert to String to support UUID
