// lib/v2/app/modules/security/profile/views/security_profile_view.dart
...
class SecurityProfileView extends GetView<SecurityProfileController> {
  const SecurityProfileView({Key? key}) : super(key: key);
