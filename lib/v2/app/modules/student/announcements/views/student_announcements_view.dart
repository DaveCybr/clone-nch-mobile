// lib/v2/app/modules/student/announcements/views/student_announcements_view.dart
import 'package:flutter/material.dart';
import 'package:get/get.dart';
import 'package:flutter_screenutil/flutter_screenutil.dart';
import 'package:flutter_html/flutter_html.dart'; // ✅ ADD THIS
...
class StudentAnnouncementsView extends GetView<StudentAnnouncementsController> {
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              // ✅ FIXED: Content Preview with HTML stripped
              Text(
  ...
  Widget _buildAnnouncementsList() {
    return Obx(() {
      ...
      final announcementsLength = controller.announcements.length;
      final selectedCat = controller.selectedCategory.value;
